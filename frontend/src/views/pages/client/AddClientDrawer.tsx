...
// ** Actions Imports
import { addClient } from 'src/store/client'
...
const SidebarAddClient = (props: SidebarAddClientType) => {
  ...
  const onSubmit = (data: ClientData) => {
    dispatch(addClient({ ...data })).then((result: any) => {
          ...
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.workPlace && <FormHelperText sx={{ color: 'error.main' }}>{errors.workPlace.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.workPhone && <FormHelperText sx={{ color: 'error.main' }}>{errors.workPhone.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.bossName && <FormHelperText sx={{ color: 'error.main' }}>{errors.bossName.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.bossPhone && <FormHelperText sx={{ color: 'error.main' }}>{errors.bossPhone.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={12} lg={6}>
              <FormControl fullWidth>
                ...
                />
                {errors.workAddress && <FormHelperText sx={{ color: 'error.main' }}>{errors.workAddress.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.personalReference1 && <FormHelperText sx={{ color: 'error.main' }}>{errors.personalReference1.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.personalReferencePhone1 && <FormHelperText sx={{ color: 'error.main' }}>{errors.personalReferencePhone1.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.personalReference2 && <FormHelperText sx={{ color: 'error.main' }}>{errors.personalReference2.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.personalReferencePhone2 && <FormHelperText sx={{ color: 'error.main' }}>{errors.personalReferencePhone2.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.workReference1 && <FormHelperText sx={{ color: 'error.main' }}>{errors.workReference1.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.workReferencePhone1 && <FormHelperText sx={{ color: 'error.main' }}>{errors.workReferencePhone1.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.workReference2 && <FormHelperText sx={{ color: 'error.main' }}>{errors.workReference2.message}</FormHelperText>}
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                />
                {errors.workReferencePhone2 && <FormHelperText sx={{ color: 'error.main' }}>{errors.workReferencePhone2.message}</FormHelperText>}
              </FormControl>
            </Grid>
